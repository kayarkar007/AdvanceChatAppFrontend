...
const Login = () => {
  ...
  const loginMutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      console.log('🔍 Login response data keys:', Object.keys(data.data))
      console.log('🔍 Nested data structure:', data.data.data)
      console.log('🔍 Nested data keys:', data.data.data ? Object.keys(data.data.data) : 'No nested data')
      
      // The actual data is nested in data.data.data
